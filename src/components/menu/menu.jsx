    ...
    return (
        <>
            <div className="menu">
                ...
                <a href="/" className="logo" data-lang-key="name">Iryna Bryzhan</a>
                <div className="menu-list">
                    <a href="#about" data-lang-key="about">About me</a>
                    <a href="#skills" data-lang-key="skills">Skills</a>
                    <a href="#portfolio" data-lang-key="portfolio">Portfolio</a>
                    ...
                    <button className={`change-lang ${lang === 'en' ? 'active' : ''}`} onClick={() => handleLanguageChange('en')}>EN</button>  </div>
